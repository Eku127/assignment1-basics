#!/bin/bash
# Training script for OpenWebText (OWT) dataset
...
TRAIN_DATA="${TRAIN_DATA:-./data/encoded/owt_train.npy}"
VAL_DATA="${VAL_DATA:-./data/encoded/owt_valid.npy}"
...
VAL_EVERY=1000
SAVE_EVERY=5000
CHECKPOINT_BASE_DIR="${CHECKPOINT_BASE_DIR:-./checkpoints/owt/lr_test}"
...
WANDB_PROJECT="${WANDB_PROJECT:-CS336_OWT_LR_Test}"
...
# ============================================================================
echo "================================================================================"
echo "OpenWebText (OWT) Training Configuration"
echo "================================================================================"
echo ""
echo "DATA:"

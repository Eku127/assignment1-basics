...
def main():
    ...
    input_path = os.path.join(project_root, "data/owt_train.txt")
    vocab_size = 32000
    ...
    # Save vocabulary
    vocab_path = os.path.join(tokenizers_dir, "owt_vocab.json")
    ...
    # Save merges
    merges_path = os.path.join(tokenizers_dir, "owt_merges.txt")
    ...
    print("\nNext steps:")
    print("  1. Run: uv run python cs336_basics/bpe/applications/encode_owt.py")
